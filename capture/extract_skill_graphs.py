...
KEEP = {
 ...
 "Particle": ["Particle","Animation","X","Y","Time","Follow","AnimSpeed","Lifetime"],
 "PlayerAnimation": ["Animation","Priority","Speed"],
 "SpellAnimation": ["FX","Animation","SpellGraphic","SpellImpact","AttachInit","Attach",
                    "AttachImpact","Follow","X","Y","Ease","ProjSpeed"],
